...
from eol import DataProvider, IdentifierConverter
...
class TestIdentifierConverter:
    ...
    def id_converter(self, provider_data_csv_file):
        return IdentifierConverter(
            provider_csv_file_path=provider_data_csv_file,
    ...
    def test_get_gbif_id_for_corresponding_eol_id(
        self, id_converter, eol_page_id, expected_gbif_id
    ):
        """
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("1057764", "21828356"),
            ("10577931", "52717353"),
            (["1057764", "10577931"], ["21828356", "52717353"]),
            (["1057764", None, "10577931"], ["21828356", None, "52717353"]),
        ],
    )
    ...
    @pytest.mark.parametrize(
        ["provider_id", "expected_eol_page_id"], [("1057764", "1234567")]
    )
    def test_identify_ambiguous_id_and_return_only_gbif(
        self, id_converter, provider_id, expected_eol_page_id
    ):
        """Feature: The module identifies an ambiguous ID from another data provider
        ...
        eol_id = id_converter.to_eol_page_id(
            provider_id, data_provider=DataProvider.WoRMS
        )
        assert eol_id == expected_eol_page_id
