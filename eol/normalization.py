...
def replace_key_by_new_key(old_key: str, new_key: str, data: dict) -> None:
    ...
    In case of a new_key value is not None, it will overwrite any already existing values associated with new_key.
    If a new_key value that is not None would overwrite another not None value associated with new_key that is
